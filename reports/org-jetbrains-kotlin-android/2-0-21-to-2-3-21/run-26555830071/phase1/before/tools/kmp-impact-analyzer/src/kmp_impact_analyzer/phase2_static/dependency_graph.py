        ...
        while queue:
            ...
            for dependent in self._imported_by.get(current, set()):
                if dependent not in visited:
                    ...
                    parent_list = visited[dependent].propagated_from
                    if current not in parent_list and visited[dependent].distance == dist + 1:
            ...
            for linked in resolver.get_linked_files(current):
                if linked not in visited:
                    ...
                    parent_list = visited[linked].propagated_from
                    if current not in parent_list and visited[linked].distance == dist + 1:
                        parent_list.append(current)
